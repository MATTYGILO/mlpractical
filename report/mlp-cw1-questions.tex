...
L1L2 regularisation experiments resulted suggest two conclusions. First, that balancing L1 and L2 parameters results
in an overall low generalisation gap and increased validation accuracy. The second is that using a larger L1 when
combined with L2 results in a greater validation accuracy, but also a larger error rate. This suggests that, when
selecting either L1 or L2 to be larger we must make a decision between validation accuracy and generalisation gap.
Interestingly, a larger L1 parameter produces a higher validation accuracy than L2 is an interesting result as
our earlier individual experiments showed that L2 on the whole had a higher accuracy than L1 for these parameter values.
Interestinly our L1L2 regularisation interestingly produced the best generalisation gap at 0.006 suggesting it is the most effective
