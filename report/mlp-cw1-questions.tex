...
for the depths tested, we found that increasing the network's depth to 2 layers slightly improved performance,
but further increasing to 3 layers did not yield any additional benefits.
This supports the general understanding that deeper networks can
...
\youranswer{L1 regularisation adds a term which is the scaled sum of the given weights.
...
Overall, our research has shown that the simplest solution seems to be the most effective for improving validation accuracy, namely label smoothing.
    Other regularisation methods such as L1, L2 and Dropout all provided some improvements, but none were as effective as label smoothing.
