...
\youranswer{
From the data we can see that as the depth of the network increases the rate at which the error decreases slows down.
Additionally,as for depths 2 and 3 and the accuracy is seriously hampered it hits a limit and seemingly remains there.
Whereas, for a single depth network the

The networking is consistently
